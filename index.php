      ...
      <div class="rev_slider" id="slider1" data-version="5.0">
        <ul>
          ...
          <li data-transition="zoomout" data-easein="default" data-easeout="default" data-slotamount="1" data-masterspeed="1200" data-delay="8000" data-title="Be a member">
            <!-- MAIN IMAGE -->
            <img src="<?php echo get_template_directory_uri();?>/img/join.png" alt="" data-bgrepeat="no-repeat" data-bgfit="cover" data-bgparallax="7" class="rev-slidebg">
          ...
          <li data-transition="zoomout" data-easein="default" data-easeout="default" data-slotamount="1" data-masterspeed="1200" data-delay="8000" data-title="Be a Sponsor">
            <!-- MAIN IMAGE -->
            <img src="<?php echo get_template_directory_uri();?>/img/spons.png" alt="" data-bgrepeat="no-repeat" data-bgfit="cover" data-bgparallax="7" class="rev-slidebg">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-8 col-sm-offset-2 text-center wow slideInUp" data-wow-duration="1.2s" data-wow-delay="0s">
          ...
          <div class="row" >
              <div class="ctr-text">
          <div class="col-sm-4"><img src="<?php echo get_template_directory_uri();?>/img/GDG-logo.png" width="300px"></div>
            <div class="col-sm-8"> 
              <p class="spec-style">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
              <img src="<?php echo get_template_directory_uri();?>/img/df17--cover-full-hd.png" alt="" >        
            </div>
      ...
      <div class="item">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
              <img src="<?php echo get_template_directory_uri();?>/img/io--cover-full-hd.png" alt="" >        
            </div>
    ...
    <div class="container"> 
      ...
      <div class="row">
        <div class="col-sm-6 sl">
          <img src="<?php echo get_template_directory_uri();?>/img/sponsors/google.png" alt="">
        </div>
        <div class="col-sm-6 sl ">
          <img src="<?php echo get_template_directory_uri();?>/img/sponsors/v307.png" alt="">
        </div>
      </div>
        <br>
        <br>
      ...
      <div class="row">
        <div class="col-sm-3 sl img-responsive">
            <br><br><br>
          <img src="<?php echo get_template_directory_uri();?>/img/partners/ITI.png" alt="">
        </div>
        <div class="col-sm-3 sl img-responsive">
            <br><br><br>
          <img src="<?php echo get_template_directory_uri();?>/img/partners/nu.png" alt="">
        </div>
          <div class="col-sm-3 sl img-responsive">
              <br><br><br>
          <img src="<?php echo get_template_directory_uri();?>/img/partners/7asibat.png" alt="">
        </div>
        <div class="col-sm-3 sl img-responsive">
            <br><br><br>
